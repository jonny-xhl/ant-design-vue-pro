...
import { getSmsCaptcha, get2step } from '@/api/AccountAPI'
...
export default {
  ...
  methods: {
    ...
    handleSubmit (e) {
      ...
      // const validateFieldsKey = customActiveKey === 'tab1' ? ['username', 'password', 'rememberMe', 'tenanId'] : ['mobile', 'captcha', 'rememberMe', 'tenanId']
